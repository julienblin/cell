...
describe("ProfilePrices", function(){
    ...
    it("should not serialize internal properties", function() {
        var profilePrice = factory.make('profilePrice').toObject();
        should.not.exists(profilePrice._id);
        should.not.exists(profilePrice.__v);
        should.not.exists(profilePrice.project);
    });
});